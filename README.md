...
Ни одной строчки внутренних данных или кода какой-либо компании не использовано, marketplace и даже domain agnostic, пробовать переранжировать можно товары, банковские продукты, документы, даже элементы интерфейса. 
